...
Module hspi_logging
  ...
  Public gLogFile As String = "HSPI_" & IFACE_NAME.ToUpper & "_DEBUG.log"
...
#Region "Logging - Functions and Routines"
  ...
  ''' <remarks></remarks>
  Public Sub WriteMessage(ByVal Message As String, _
                          Optional ByVal MessageType As MessageType = MessageType.Informational,
                          Optional ByVal LogColor As String = "#000000", _
                          Optional ByVal LogPriority As Integer = 0, _
                          Optional ByVal LogSource As String = IFACE_NAME, _
  ...
  ''' <remarks></remarks>
  Public Sub WriteToDisk(ByVal strLogType As String, _
